// This is trying to show us how to send JSON over HTTP.

// We are using the `.stringify()` method of the `JSON` object in order to convert the JavaScript object into a string
// This makes it easier to parse (more on parsing in the next lesson)
...
async function updateLocationById(id, locationObj) {
    ...
    const response = await fetch(path, {
        ...
        mode: 'cors',
        headers: getHeaders(),
        // we can send the `body` contents as a string instead of a JavaScript object
